...
/* Parse-time resolver result, Code splices .py defs, Native registers extern bindings and classes, the VM sees Call/CallExtern. canonical dedupes diamond imports by resolved path. */
#[derive(Clone)]
pub enum Resolved {
