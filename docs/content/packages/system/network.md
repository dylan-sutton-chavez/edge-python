...
Known limitations: the CLI suspends on `fetch` like the JS host but has no sockets. The irreducible difference is CORS, a browser rule that does not apply in the CLI.
